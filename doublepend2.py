...
#    xpos_text.set_text('')
    xpos1.set_data([],[])
#    return line, time_text, energy_text, xpos_text, xpos1
    return line, time_text, energy_text, xpos1
...
#    xpos_text.set_text('x1,y1 = %.3f, %.3f' % (x1, y1))    
        
    xpos1.set_data(tlist,ylist)
    return line, time_text, energy_text, xpos1
